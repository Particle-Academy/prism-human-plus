...
final readonly class HumanPlusToolset
{
     ...
     */
    public function forAttachment(string $attachmentId, array $approvalTools = []): array
    {
        return array_map(
            fn (ToolDefinition $definition): SurfaceTool => new SurfaceTool($this->humanPlus, $attachmentId, $definition, in_array($definition->name, $approvalTools, true)),
            $this->humanPlus->tools($attachmentId),
        );
    }
}
